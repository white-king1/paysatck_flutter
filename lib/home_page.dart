...
class _HomePageState extends State<HomePage> {
  String backendUrl = 'https://bankablewisdom.com/';
  String paystackPublicKey = 'pk_test_3addde3a5b36083dfec1153610ed2cbc73413d86';
  String appName = 'Bankable Wisdom App';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('FLUTTER PAYSTACK PAYMENT'),
      ),
